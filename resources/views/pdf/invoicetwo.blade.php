...
<div class="text-container"><span class="t s0" style="left:53px;bottom:572px;letter-spacing:0.05px;font-size:12px;">
{{
...
<span class="t s6" style="left:525px;bottom:788px;letter-spacing:0.1px;">{{ $invoice->candidate_mobile }}</span></div>

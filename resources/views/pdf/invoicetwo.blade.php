...
<div class="text-container"><span class="t s0" style="left:53px;bottom:543px;letter-spacing:0.05px;">
{{
...
<span class="t s1" style="left:76px;bottom:504px;letter-spacing:-0.18px;">
{{
...
<span class="t s1" style="left:76px;bottom:486px;letter-spacing:-0.18px;">
{{
...
<span class="t s1" style="left:76px;bottom:468px;letter-spacing:-0.18px;">
{{
...
<span class="t s1" style="left:76px;bottom:450px;letter-spacing:-0.18px;">
{{
    $invoice->package === 'career_starter' ? '' :
...
<span class="t s0" style="left:500px;bottom:838px;letter-spacing:0.17px;">{{ $invoice->candidate_name }}</span>
<span class="t s6" style="left:525px;bottom:812px;letter-spacing:0.1px;">{{ $invoice->candidate_email }}</span>
<span class="t s6" style="left:525px;bottom:764px;letter-spacing:0.1px;">{{ $invoice->candidate_address }}</span>

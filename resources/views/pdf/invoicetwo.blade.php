...
<div class="text-container"><span class="t s0" style="left:53px;bottom:572px;letter-spacing:0.05px;font-size:12px;font-weight:590;">
{{
...
<span class="t s1" style="left:76px;bottom:554px;letter-spacing:-0.18px;font-size:10px;font-weight:590;">
{{
...
<span class="t s1" style="left:76px;bottom:536px;letter-spacing:-0.18px;font-size:10px;font-weight:590;">
{{
...
<span class="t s1" style="left:76px;bottom:518px;letter-spacing:-0.18px;font-size:10px;font-weight:590;">
{{
...
<span class="t s1" style="left:76px;bottom:500px;letter-spacing:-0.18px;font-size:10px;font-weight:590;">
{{
...
<span class="t s1" style="left:76px;bottom:482px;letter-spacing:-0.18px;font-size:10px;font-weight:590;">
{{
    $invoice->package === 'career_starter' ? '' :
...
<span class="t s1" style="left:76px;bottom:464px;letter-spacing:-0.18px;font-size:10px;font-weight:590;">
{{
    $invoice->package === 'career_starter' ? '' :
...
<span class="t s1" style="left:76px;bottom:446px;letter-spacing:-0.18px;font-size:10px;font-weight:590;">
{{
    $invoice->package === 'career_starter' ? '' :
    ($invoice->package === 'growth_package' ? '' :
...
<span class="t s1" style="left:76px;bottom:428px;letter-spacing:-0.18px;font-size:10px;font-weight:590;">
{{
    $invoice->package === 'career_starter' ? '' :
    ($invoice->package === 'growth_package' ? '' :
...
<span class="t s1" style="left:76px;bottom:410px;letter-spacing:-0.18px;font-size:10px;font-weight:590;">
{{
    $invoice->package === 'career_starter' ? '' :
    ($invoice->package === 'growth_package' ? '' :

...
<div class="text-container"><span class="t s0" style="left:53px;bottom:572px;letter-spacing:0.05px;font-size:12px;font-weight:600;">
{{
...
<span class="t s2" style="left:178px;bottom:1081px;letter-spacing:0.15px;">{{ \Carbon\Carbon::parse($invoice->invoice_date)->format('dmy') }}</span>

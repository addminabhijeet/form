...
<span class="t s6" style="left:525px;bottom:740px;letter-spacing:0.1px;">{{ $invoice->candidate_address }}</span>
<span class="t s6" style="left:525px;bottom:788px;letter-spacing:0.1px;">{{ $invoice->candidate_email }}</span></div>
